...
CREATE TABLE dbo.ForeignKeys -- feel free to use a permanent table
(
...
INSERT dbo.ForeignKeys(drop_script) SELECT @drop;
...
UPDATE dbo.ForeignKeys SET create_script = @create;
...
*/
SELECT drop_script FROM dbo.ForeignKeys
SELECT create_script FROM dbo.ForeignKeys
