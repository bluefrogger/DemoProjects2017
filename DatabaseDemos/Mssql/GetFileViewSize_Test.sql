...
IF Object_id('output_test') IS NOT NULL
...
CREATE TABLE output_Test (Directory varchar(400), [FileName] VARCHAR(400), SizeInMB DECIMAL(13,3), SizeInKB DECIMAL(13,3),SizeInB bigint)
...
and directory not like '%\System Volume Informa%'
            ...
            ------------------------------------------------------------------------------------------
             ...
             DELETE FROM ##tempFilePaths
               ...
               DELETE FROM ##tempFileInformation;
                ...
                INSERT INTO output_Test--(FilePath, SizeInMB, SizeInKB)
                SELECT 
                        @curdir,
                        FilePath,
    ...
    DELETE FROM output_Test WHERE Directory is null      
----------------------------------------------
-- DROP temp tables
----------------------------------------------          
DROP TABLE ##Tempoutput 
